...
DROP POLICY IF EXISTS "phone_verifications_service_only" ON public.phone_verifications;
...
DROP POLICY IF EXISTS "payapp_pending_rebills_service_only" ON public.payapp_pending_rebills;
