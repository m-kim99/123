...
export function SubcategoryDetail() {
  ...
  const {
    ...
    context: 'subcategory_detail',
    getDocumentTitle: (id) => subcategoryDocuments.find((d) => d.id === id)?.name,
  });
        ...
        >
          <DialogContent className="max-w-[840px] h-[90vh] flex flex-col overflow-hidden gap-0 p-0 rounded-[16px]" hideClose>
            ...
            <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-5 py-3.5 border-b border-slate-100 shrink-0">
              <div className="w-9 h-9 rounded-lg hidden sm:flex items-center justify-center shrink-0" style={{ background: V1.blueSoft }}>
              ...
              {previewDoc && (
                <>
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">{t('documentMgmt.share', { defaultValue: '공유' })}</span>
                  </button>
