...
import snsGoogle from '@/assets/social/sns-google.png';
import snsApple from '@/assets/social/sns-apple.png';
import snsKakao from '@/assets/social/sns-kakao.png';
import snsNaver from '@/assets/social/sns-naver.png';
...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-screen flex bg-white dark:bg-[#0b1220] overflow-x-hidden md:h-screen md:overflow-hidden">
      ...
      {isMobileDevice && <div className="md:hidden flex-1 relative min-h-screen flex flex-col items-center justify-center">
        <video
          className="absolute inset-0 w-full h-full object-cover pointer-events-none"
          src="/login-bg.mp4"
          autoPlay
