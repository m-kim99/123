  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          'absolute right-4 top-4 rounded-md p-1 bg-blue-500 hover:bg-blue-600 ring-offset-background transition-all focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none',
          closeClassName
        )}
      >
