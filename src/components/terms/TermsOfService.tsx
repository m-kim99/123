...
const TermsZh = () => (
  <>
    ...
    <h3 className="font-semibold text-slate-900">第2条（定义）</h3>
    <p>① 本条款所使用术语的定义如下。</p>
    <ul className="list-disc pl-5 space-y-1">
      <li>"服务"是指公司提供的在线平台服务，会员可将其持有的文档以云端方式存储和管理，并利用人工智能（AI）技术对文档信息进行检索、搜索和分析。</li>
      <li>"TrayStorage Connect"是指公司为提供服务而运营的网页及移动端平台。</li>
      <li>"会员"是指同意本条款并按照公司规定的程序完成会员注册后使用服务的人。</li>
      <li>"管理员"是指在组织内被授予部门创建、权限管理、全部文档统计查看等管理功能权限的会员。</li>
      <li>"组员"是指在管理员授予的权限范围内可以登记、查询、编辑文档的会员。</li>
      <li>"帖子"是指会员上传至服务的文档文件、照片、图片等一切资料。</li>
      <li>"AI服务"是指利用光学字符识别（OCR）、文档内容分析、检索、摘要、分类、问答等人工智能技术，以自动化方式提供文档相关信息的功能，包括OpenAI GPT及Naver Clova OCR等第三方提供的AI模型。</li>
      <li>"AI OCR"是指自动识别并提取图片或扫描文档中文字信息的光学字符识别技术。</li>
      <li>"免费套餐"是指在公司规定范围内无需支付费用即可使用服务的套餐，适用公司规定的每个组织成员数量等限制。</li>
      <li>"付费套餐"是指会员支付使用费用后可使用公司提供的基本功能的套餐（如基础版套餐等）。</li>
      <li>"成员"是指在一个组织（会员账户）内注册使用服务的管理员及组员的统称。</li>
      <li>"TrayStorage产品"是指用于保管和管理纸质文档的物理保管箱，可贴附NFC标签与服务联动，为公司销售的付费产品。</li>
      <li>"NFC标签"是指利用近场通信（Near Field Communication）技术，将TrayStorage产品与服务联动的贴纸型装置。</li>
    </ul>
    <p>② 本条款未规定的术语含义，依相关法令及一般商业惯例处理。</p>

    <h3 className="font-semibold text-slate-900">第3条（条款的公示与修订）</h3>
    <p>① 公司将本条款内容公示于服务初始页面或公司官网（www.traystorage.net），以便会员随时查阅。</p>
    <p>② 公司可在不违反《条款规制法》、《促进信息通信网络利用及信息保护等相关法律》（以下简称"信息通信网络法"）、《电子商务等消费者保护相关法律》等相关法令的范围内修订本条款。</p>
    <p>③ 公司修订条款时，将明确修订内容及适用日期，自适用日期7日前在服务页面及公司官网公告。但如变更事项对会员不利或属重大变更，则自适用日期30日前公告，并通过会员登记的电子邮件或手机号码单独通知。</p>
    <p>④ 公司依第③项公告或通知修订条款，并明确告知"会员在适用日期前未表示意见即视为同意"，而会员未明确表示拒绝的，视为会员已同意修订条款。</p>
    <p>⑤ 会员不同意修订条款适用的，公司不得对该会员适用修订条款内容，此时会员可解除使用合同。</p>

    <h3 className="font-semibold text-slate-900">第4条（条款外准则）</h3>
    <p>① 本条款未规定的事项及本条款的解释，依《条款规制法》、信息通信网络法、《个人信息保护法》、《电子商务等消费者保护相关法律》、《人工智能基本法》、《电子文件及电子交易基本法》等相关法令或商业惯例处理。</p>
    <p>② 公司可在必要时制定服务的具体使用指南（运营政策），并将其公示于服务页面或以其他方式通知会员。</p>

    <h3 className="font-semibold text-slate-900">第5条（会员注册）</h3>
    <p>① 使用者按照公司规定的注册表格填写会员信息后，通过表示同意本条款的意思表示申请会员注册。</p>
    <p>② 公司对依第①项申请注册为会员的使用者，除下列各项情形外均予以登记为会员：</p>
    <ul className="list-disc pl-5 space-y-1">
      <li>申请人此前依本条款曾丧失会员资格（但丧失会员资格后已满2年，并获得公司再加入许可的除外）</li>
      <li>登记内容存在虚假、遗漏或错误</li>
      <li>会员退出后未满7日申请再加入</li>
      <li>处于使用限制期间的会员任意解除使用合同后申请再加入</li>
      <li>其他因公司技术原因，判断为登记为会员将显著产生障碍的情形</li>
    </ul>
    <p>③ 会员注册合同的成立时间，以公司的承诺到达会员之时为准。</p>
    <p>④ 会员注册时登记的事项如有变更，应立即通过电子邮件或其他方式告知公司变更内容。</p>
    <p>⑤ 因未按第④项告知变更事项而产生的不利后果，公司不承担责任。</p>

    <h3 className="font-semibold text-slate-900">第6条（会员退出及资格丧失）</h3>
    <p>① 会员可随时向公司申请退出，公司将立即处理会员退出。</p>
    <p>② 会员如有下列情形之一，公司可限制或停止其会员资格：</p>
    <ul className="list-disc pl-5 space-y-1">
      <li>申请注册时登记虚假内容</li>
      <li>妨碍其他会员使用服务或盗用其信息等扰乱电子商务秩序的行为</li>
      <li>利用服务从事法令或本条款禁止或违反公共秩序及良俗的行为</li>
    </ul>
    <p>③ 公司限制或停止会员资格后，若同一行为反复发生2次以上或30日内未纠正相关事由的，公司可取消该会员资格。</p>
    <p>④ 公司取消会员资格时，将注销该会员登记。此时应通知该会员，并在注销登记前给予至少30日以上的陈述机会。</p>
    <p>⑤ 会员退出或丧失会员资格时，其帖子及个人信息将立即删除。但依相关法令及公司个人信息处理方针需要保存的信息，将在一定期间保存后删除。</p>

    <h3 className="font-semibold text-slate-900">第7条（休眠会员转换）</h3>
    <p>① 会员1年内未登录服务的，公司将该会员转换为休眠会员，并单独分离保管其个人信息。</p>
    <p>② 转换为休眠会员后经过3年，会员的个人信息及帖子将被完全删除。</p>
    <p>③ 公司将在休眠转换预定日前30日，通过电子邮件等方式通知会员休眠转换事宜。</p>
    <p>④ 休眠会员可通过登录进行本人验证程序，解除休眠状态并重新使用服务。</p>

    <h3 className="font-semibold text-slate-900">第8条（服务的提供及变更）</h3>
    <p>① 公司向会员提供以下服务：</p>
    <ul className="list-disc pl-5 space-y-1">
      <li>文档文件及图片的云端存储与管理服务</li>
      <li>按部门分类和管理文档的功能</li>
      <li>利用NFC标签与物理保管箱联动的服务</li>
      <li>通过AI OCR自动识别和提取文档文字</li>
      <li>基于AI的文档检索、分析、摘要、问答功能</li>
      <li>聊天及语音指令方式的AI界面</li>
      <li>文档保管期限设置、统计数据提供、公告发布等附加功能</li>
      <li>权限管理功能（无法访问/查看者/编辑者/管理者四个等级）</li>
      <li>公司另行开发或通过合作协议等方式向会员提供的其他一切服务</li>
    </ul>
    <p>② 公司可根据服务质量提升、技术发展、运营需要，变更服务的全部或部分内容。</p>
    <p>③ 服务的内容、使用方法、使用时间发生变更时，公司将于变更前至少7日在服务页面公告变更事由、变更后的服务内容及提供日期等，或通知会员。</p>
    <p>④ 公司可根据公司政策及运营需要，修改、中断或变更免费提供的服务的部分或全部，除相关法令另有规定外，不对此向会员提供单独补偿。</p>

    <h3 className="font-semibold text-slate-900">第9条（服务使用时间及中断）</h3>
    <p>① 服务原则上全年365天、每日24小时提供，除公司业务或技术上存在特殊障碍的情形。</p>
    <p>② 尽管有第①项规定，公司在下列情形下可限制或中断服务的全部或部分：</p>
    <ul className="list-disc pl-5 space-y-1">
      <li>计算机等信息通信设备的维护检修、更换及故障、通信中断等事由发生时</li>
      <li>因服务相关设施维护等工程而不得已的情形</li>
      <li>因停电、各项设施故障或使用量激增等致使无法正常使用服务的情形</li>
      <li>因与服务提供商合同终止等公司各项事由致使无法维持服务的情形</li>
      <li>其他因自然灾害、国家紧急状态等不可抗力事由</li>
    </ul>
    <p>③ 因第②项事由致使服务暂时中断而使会员或第三方遭受损失的，除公司存在故意或重大过失外，公司不承担责任。</p>
    <p>④ 公司中断服务时，除第③项不可抗力事由外，将至少提前7日在服务页面公告或通知会员。</p>

    <h3 className="font-semibold text-slate-900">第10条（套餐及支付）</h3>
    <p>① 公司将服务分为免费套餐和付费套餐提供。各套餐的具体使用范围及限制事项依第12条规定。</p>
    <p>② 公司提供的套餐种类及使用费用如下。所示使用费用均为含增值税（VAT）金额。</p>
    <table className="w-full border-collapse border border-slate-300 my-2 text-sm">
      <thead><tr className="bg-slate-100"><th className="border border-slate-300 p-2 text-left">套餐</th><th className="border border-slate-300 p-2 text-left">使用费用</th><th className="border border-slate-300 p-2 text-left">主要内容</th></tr></thead>
      <tbody>
    ...
    <p>⑦ 会员可使用信用卡支付、无存折存款、虚拟账户转账及公司指定的其他支付方式支付使用费用。</p>
    <p>⑧ 因会员选择的支付方式额度超限、余额不足、支付方式被任意解除等原因拖欠使用费用的，公司可自拖欠发生之日起中断付费套餐的服务使用，或将其转换为免费套餐。</p>
    <p>⑨ 会员对支付方式不具有正当使用权限，或在支付后对该支付方式提出异议或拒绝支付的，公司可中断服务提供。</p>
    <p>⑩ 公司可根据服务种类及期间变更使用费用，此时依第3条程序进行公告及通知。但变更前已签订的金额不追溯适用。</p>

    <h3 className="font-semibold text-slate-900">第11条（申购撤回及退款）</h3>
    <p>① 首次支付付费套餐的会员，自结算日起7日内未使用服务的，可撤回申购，此时公司全额退还已结算款项。</p>
    <p>② 尽管有第①项规定，下列情形下申购撤回可能受到限制：</p>
    <ul className="list-disc pl-5 space-y-1">
      <li>因会员责任致使服务灭失或毁损的情形</li>
      <li>会员已大量使用服务，致使其价值显著减少的情形</li>
    </ul>
    <p>③ 使用定期扣款型付费套餐的会员，在结算日起7日后申请解约及退款的，原则上已结算的该结算周期（当月）款项不予退还，服务使用权限将维持至该结算周期到期为止，此后自动续订将被中断。</p>
    <p>④ 会员依政府公告的《内容使用者保护指南》等相关法令可获得退款的，公司可在该指南规定范围内收取退款手续费。</p>
    <p>⑤ 退款原则上按会员支付时使用的相同方式处理，若无法以相同方式退款，则按公司规定的方式退款。</p>
    <p>⑥ 退款处理将在退款申请之日起7个工作日内完成。</p>
    <p>⑦ 免费套餐的使用不存在可退款金额。</p>

    <h3 className="font-semibold text-slate-900">第12条（各套餐服务使用范围及限制）</h3>
    <p>① 免费套餐与付费套餐的服务使用范围及限制如下。</p>
    <table className="w-full border-collapse border border-slate-300 my-2 text-sm">
      <thead><tr className="bg-slate-100"><th className="border border-slate-300 p-2 text-left">区分</th><th className="border border-slate-300 p-2 text-left">内容</th></tr></thead>
      <tbody>
        <tr><td className="border border-slate-300 p-2">文件上传</td><td className="border border-slate-300 p-2">单次上传最大50MB，支持格式为PDF、JPG、PNG</td></tr>
    ...
    <p>③ 公司为服务的稳定运营，在必要时可变更上述限制事项，变更时依第3条提前公告。</p>

    <h3 className="font-semibold text-slate-900">第13条（帖子的管理）</h3>
    <p>① 会员在服务内发布的帖子的著作权归属于该帖子的著作权人。</p>
    <p>② 会员不得在服务中登记下列内容的帖子：</p>
    <ul className="list-disc pl-5 space-y-1">
      <li>侵害他人权利、名誉、信用或其他正当利益的内容</li>
      <li>被判断为与犯罪行为相关的内容</li>
      <li>侵害公司或第三方著作权等知识产权的内容</li>
      <li>损害公司或第三方名誉或妨碍其业务的内容</li>
      <li>淫秽或暴力性信息、影像、声音等违反公共秩序及良俗的内容</li>
      <li>包含以下个人信息及敏感信息的文档：居民登记证号码・护照号码・驾驶证号码・外国人登记号码等个人识别信息 / 印鉴证明书・登记权利证等证明法律权利义务的文件 / 家庭关系证明书・户籍誊本・抄本等证明身份关系的文件 / 存折复印件・信用卡信息等含金融信息的文件 / 体检结果・诊疗记录等含医疗信息的文件 / 简历・职业证明书等详细记载个人经历的文件</li>
    </ul>
    <p>③ 会员如需登记包含第②项所述信息的文档，必须先删除或进行遮盖（打码）处理后方可登记。</p>
    <p>④ 会员违反第②项登记帖子的，公司可不经事先通知删除该帖子或拒绝其发布，并可限制该会员使用服务或解除使用合同。</p>
    <p>⑤ 因会员违反第②项发布帖子致使公司或第三方遭受损失的，该会员应承担赔偿责任。</p>
    <p>⑥ 公司建议在与NFC标签联动使用时，仅登记能够识别物理保管箱内文档种类及大致内容的最少信息。</p>

    <h3 className="font-semibold text-slate-900">第14条（AI服务提供及告知事项）</h3>
    <p>① 公司对会员登记的帖子提供以下AI服务：</p>
    <ul className="list-disc pl-5 space-y-1">
      <li>AI OCR（光学字符识别）：自动从图片或扫描文档中提取文字</li>
      <li>文档检索及分类：分析文档内容以提供自动分类及检索功能</li>
      <li>问答：通过聊天或语音指令查询文档信息</li>
      <li>文档摘要及分析：文档内容摘要及统计分析</li>
    </ul>
    <p>② 公司为提供AI服务，使用OpenAI GPT及Naver Clova OCR等第三方提供的AI模型。</p>
    <p>③ AI OCR在会员上传帖子后即时实时处理，处理结果存储于Supabase云服务器（基于AWS）。</p>
    <p>④ 公司提供的AI服务具有以下特性及限制事项：</p>
    <ul className="list-disc pl-5 space-y-1">
      <li>AI服务仅为辅助性信息提供手段，不能替代法律、会计、税务、医疗、人事等专业判断。</li>
      <li>AI提供信息的完整性、准确性、时效性不受保证，会员在做最终判断时须务必核对原始文档。</li>
      <li>AI分析结果仅可作为参考资料使用，不得作为重要决策的唯一依据。</li>
    </ul>
    <p>⑤ 对因AI服务的错误、不准确或会员信赖AI服务结果而产生的损失，除公司存在故意或重大过失外，公司不承担责任。</p>

    <h3 className="font-semibold text-slate-900">第15条（会员对AI处理的权利）</h3>
    <p>① 会员对AI服务提供的结果可行使以下权利：</p>
    <ul className="list-disc pl-5 space-y-1">
      <li>说明请求权：请求说明AI处理结果的权利</li>
      <li>异议提出权：对明显错误或不当结果提出异议的权利</li>
      <li>请求人工介入权：请求对自动化处理进行人工审核的权利</li>
    </ul>
    <p>② 公司收到第①项请求后，将在技术可行范围内审查并采取必要措施。</p>
    <p>③ 会员可通过客服中心（support@traystorage.net，02-333-7334）行使第①项权利。</p>

    <h3 className="font-semibold text-slate-900">第16条（帖子的AI训练利用）</h3>
    <p>① 公司目前不将会员的帖子用作一般AI模型训练数据。</p>
    <p>② 但为提升服务质量及功能升级，公司可将完全去除个人识别信息的匿名化统计信息用于生成及分析，或为改善服务错误及验证质量提升所需的技术验证目的使用帖子。</p>
    <p>③ 公司未来如欲将会员帖子用于AI模型训练，将事先取得会员的明确同意。</p>
    <p>④ 会员可随时拒绝其帖子被用于AI训练。</p>

    <h3 className="font-semibold text-slate-900">第17条（个人信息的保护及国外转移）</h3>
    <p>① 公司依相关法令努力保护会员的个人信息，个人信息的保护及利用适用相关法令及公司的个人信息处理方针。</p>
    <p>② 公司为提供服务，将会员的帖子及个人信息存储于云服务器（Supabase，基于AWS），该服务器可能位于海外。</p>
    <p>③ 个人信息国外转移相关事项：转移的个人信息项目（会员信息、帖子、AI处理结果）、转移国家（美国等Supabase服务器所在地）、转移目的（提供云端服务及数据存储）、保有及使用期间（至会员退出为止或依相关法令规定的保存期间）</p>
    <p>④ 公司可在未来考虑转换为国内服务器，服务器位置变更时将提前公告。</p>
    <p>⑤ 公司的个人信息处理方针可在服务页面及公司官网查阅。</p>

    <h3 className="font-semibold text-slate-900">第18条（会员的义务）</h3>
    <p>① 会员不得从事下列行为：申请或变更时登记虚假内容、盗用他人信息、侵害公司或第三方知识产权等权利、损害公司或第三方名誉或妨碍其业务的行为、发布淫秽或暴力性信息、未经公司同意以营利为目的使用服务、传播计算机病毒等恶意程序、未经公司事先许可使用或向他人提供通过服务获得的信息、利用自动化手段未经授权访问服务或收集数据、对公司服务器造成负面影响或妨碍服务运营、其他违反相关法令或违背善良风俗及社会通念的行为。</p>
    <p>② 管理员对部门创建、访问权限授予、组员管理等承担责任，因权限设置错误或不当授权产生的问题，管理员承担首要责任。</p>
    <p>③ 会员对成员登记及管理承担责任，使用付费套餐时应知悉并遵守使用费用依登记成员数核算的规定。</p>
    <p>④ 会员应遵守本条款及相关法令规定的事项。</p>

    <h3 className="font-semibold text-slate-900">第19条（权限管理）</h3>
    <p>① 服务运营基于管理员与组员区分的角色权限管理体系。</p>
    <p>② 管理员的权限及责任：部门创建及删除、文档大分类及细分类别的创建及管理、按组员设置部门访问权限（无法访问/查看者/编辑者/管理者四个等级）、查看全部部门文档及统计信息（目前每个组织仅限1名管理员，未来可能更新为支持指定多名管理员）。</p>
    <p>③ 组员的权限：在其所属部门内创建文档大分类及细分类别、登记・查询・编辑其所属部门的文档、经管理员许可对其他部门文档的有限访问。</p>
    <p>④ 请求其他部门访问权限的程序：组员向管理员请求其他部门访问权限 → 管理员设置访问级别 → 设置完成后组员可访问该部门。</p>
    <p>⑤ 管理员在设置权限时应依最小权限原则，仅授予业务执行所需的最少权限。</p>

    <h3 className="font-semibold text-slate-900">第20条（公司的义务）</h3>
    <p>① 公司不从事相关法令及本条款禁止或违背良好风俗的行为，并竭尽全力持续、稳定地提供服务。</p>
    <p>② 公司为使会员能够安全使用服务，须具备保护个人信息（含信用信息）的安保体系，并公示及遵守个人信息处理方针。</p>
    <p>③ 公司对会员就服务使用提出的意见或不满，认定为正当的，应予以处理。</p>
    <p>④ 公司将依相关法令规定的期间保存与付费结算相关的结算信息。</p>
    <p>⑤ 公司投保产品责任保险、个人信息保护赔偿责任保险、营业赔偿责任保险、网络保险，以应对服务提供过程中可能发生的风险。</p>

    <h3 className="font-semibold text-slate-900">第21条（著作权的归属及使用限制）</h3>
    <p>① 公司制作的著作物的著作权及其他知识产权归属于公司。</p>
    <p>② 会员不得未经公司事先许可，将因使用服务获得的、知识产权归属于公司的信息用于营利目的或提供第三方使用。</p>
    <p>③ 会员在服务内发布的帖子的著作权归属于该帖子的著作权人。</p>
    <p>④ 会员不得对通过使用服务获得的信息进行加工、销售等，不得将服务中登载的资料用于商业用途。</p>

    <h3 className="font-semibold text-slate-900">第22条（NFC产品销售及瑕疵处理）</h3>
    <p>① 公司通过公司直营销售渠道及网络销售渠道（Auction、Gmarket、11番街、Naver智能商店、Cafe24自营商城等）销售TrayStorage产品（含NFC标签）。</p>
    <p>② TrayStorage产品存在瑕疵的，会员可在购买之日起1年内申请免费售后服务。</p>
    <p>③ 产品瑕疵的售后咨询可通过客服中心（02-333-7334，support@traystorage.net）受理。</p>
    <p>④ 产品的更换、退货、退款事项依《电子商务等消费者保护相关法律》等相关法令处理。</p>

    <h3 className="font-semibold text-slate-900">第23条（数据保管及备份）</h3>
    <p>① 公司努力安全保管会员的帖子及服务使用数据。</p>
    <p>② 会员退出时，其帖子及个人信息将立即删除。但备份数据（1年）、AI处理日志（1年）、依相关法令需保存的信息（依该法令规定的期间）将在明示期间内保管。</p>
    <p>③ 转换为休眠会员时，个人信息将单独分离保管，休眠转换后经过3年，全部数据将被完全删除。</p>
    <p>④ 因自然灾害、黑客攻击、系统故障等不可抗力事由造成的数据丢失，除公司存在故意或重大过失外，公司不承担责任。</p>
    <p>⑤ 建议会员对重要数据另行保留备份。</p>

    <h3 className="font-semibold text-slate-900">第24条（免责条款）</h3>
    <p>① 因自然灾害、战争、电信运营商服务中断、黑客攻击、DDOS攻击等非公司过错事由导致的服务中断及其造成的损失，公司不承担责任。</p>
    <p>② 因会员过错导致服务使用障碍的，公司不承担责任。</p>
    <p>③ 公司对会员因使用服务而期待获得的利益的丧失不承担责任。</p>
    <p>④ 公司对会员在服务中登载的信息、资料、事实的可信度、准确性等内容不承担责任。</p>
    <p>⑤ 因会员之间或会员与第三方之间以服务为媒介进行交易等产生的事项，公司不承担责任。</p>
    <p>⑥ 除相关法令另有规定外，公司对免费提供的服务使用不承担责任。</p>
    <p>⑦ 对AI服务特性可能产生的错误、不准确信息提供、意外结果，除公司存在故意或重大过失外，公司不承担责任。</p>

    <h3 className="font-semibold text-slate-900">第25条（损害赔偿）</h3>
    <p>① 公司或会员违反本条款致使对方遭受损失的，应承担赔偿责任。但无故意或过失的，不在此限。</p>
    <p>② 因服务中断、错误等致使会员遭受损失的，公司向付费会员提供1至3个月免费使用权，对免费会员不予单独补偿。</p>
    <p>③ 公司提供的补偿不能代替现金赔偿，会员可根据损失程度另行请求损害赔偿。</p>
    <p>④ 会员违反本条款致使公司遭受损失的，会员应对公司承担赔偿责任。</p>

    <h3 className="font-semibold text-slate-900">第26条（纠纷的解决）</h3>
    <p>① 公司为反映会员提出的正当意见或不满并处理相应损害赔偿，设立并运营损害赔偿处理机构。</p>
    <p>② 公司对会员提交的不满事项及意见予以优先处理。但难以迅速处理的，将立即通知会员相关事由及处理日程。</p>
    <p>③ 公司与会员之间发生的电子商务纠纷，会员提出损害救济申请的，可依公平交易委员会或市・道知事委托的纠纷调解机构的调解处理。</p>

    <h3 className="font-semibold text-slate-900">第27条（管辖权及适用法律）</h3>
    <p>① 本条款未明示的事项，依《电子商务等消费者保护相关法律》、《条款规制法》、信息通信网络法、《个人信息保护法》、《人工智能基本法》等相关法令及商业惯例处理。</p>
    <p>② 因使用服务产生的纠纷需要诉讼的，向民事诉讼法规定的管辖法院提起。</p>

    <h3 className="font-semibold text-slate-900">第28条（客服中心）</h3>
    <p>会员对服务使用如有疑问，可通过以下客服中心联系：</p>
    <ul className="list-disc pl-5 space-y-1">
      <li>电话：02-333-7334</li>
      <li>电子邮箱：support@traystorage.net</li>
      <li>运营时间：工作日 09:00 ~ 18:00（周末及法定节假日除外）</li>
    </ul>

    <h3 className="font-semibold text-slate-900">附则</h3>
    <p><strong>第1条（施行日）</strong> 本条款自2026年7月1日起施行。</p>
    <p><strong>第2条（过渡措施）</strong> ① 本条款施行前加入的会员适用修订后的条款。② 在测试阶段加入的会员在转换为付费套餐时，可能获得单独的优惠待遇。③ 本条款施行时正在免费使用服务的会员将转换为免费套餐会员，成员数超过10人时应在公司规定的宽限期内转换为付费套餐。</p>
...
export const TermsOfServiceContent = () => {
  ...
  if (i18n.language === 'zh') return <TermsZh />;
  return <TermsKo />;
};
